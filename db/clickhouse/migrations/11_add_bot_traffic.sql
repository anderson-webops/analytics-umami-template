ALTER TABLE umami.website_event ADD COLUMN "is_bot" UInt8 AFTER "distinct_id";
ALTER TABLE umami.website_event ADD COLUMN "bot_name" LowCardinality(String) AFTER "is_bot";
ALTER TABLE umami.website_event ADD COLUMN "bot_category" LowCardinality(String) AFTER "bot_name";

ALTER TABLE umami.website_event_stats_hourly ADD COLUMN "is_bot" UInt8 AFTER "distinct_id";
ALTER TABLE umami.website_event_stats_hourly ADD COLUMN "bot_name" LowCardinality(String) AFTER "is_bot";
ALTER TABLE umami.website_event_stats_hourly ADD COLUMN "bot_category" LowCardinality(String) AFTER "bot_name";
