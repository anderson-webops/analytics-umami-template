...
export const API_VERSION = '4.2.1';
...
export const operations = {
  ...
  getWebsiteReplay: {
    ...
    queryParams: ['until', 'chunkIndex', 'eventIndex'],
    hasBody: false,
  },
  getWebsiteReplays: {
...
export abstract class GeneratedUmamiClient {
  ...
  /**
   * Create or update teams team id owner
   * `POST /api/teams/{teamId}/owner`
   */
  postTeamsTeamIdOwner(
    input: OperationInput<'postTeamsTeamIdOwner'>,
    options?: RequestOptions,
  ): Promise<OperationOutput<'postTeamsTeamIdOwner'>> {
    return this.execute('postTeamsTeamIdOwner', input, options);
  }
